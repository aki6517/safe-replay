 ...
 * ファイル解析統合インターフェース
 */
import { parsePDF, getPDFMetadata } from './pdf.ts';
import { parseDOCX, parseDOCXAsHTML } from './docx.ts';
import { parseXLSX, getXLSXSheetNames } from './xlsx.ts';
import { parsePPTX, getPPTXSlideCount } from './pptx.ts';
...
// 個別のパーサー関数もエクスポート
export { parsePDF, getPDFMetadata } from './pdf.ts';
export { parseDOCX, parseDOCXAsHTML } from './docx.ts';
export { parseXLSX, getXLSXSheetNames } from './xlsx.ts';
export { parsePPTX, getPPTXSlideCount } from './pptx.ts';

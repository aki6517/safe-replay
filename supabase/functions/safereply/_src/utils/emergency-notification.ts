 ...
 * - システム停止検知時の通知
 */
import { sendFlexMessage, isLineClientAvailable } from '../services/line.ts';
import { createEmergencyFlexMessage } from '../services/flex-messages/emergency.ts';
import { getAllowedUserIds } from './security.ts';
